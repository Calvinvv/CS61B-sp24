...
public class LinkedListDeque61BTest {
    ...
    public void get() {
        ...
        assertThat(lld.get(4)).isEqualTo(4);
        assertThat(lld.get(-1)).isNull();
    }
    ...
    public void getRecursive() {
        ...
        assertThat(lld.getRecursive(4)).isEqualTo(4);
        assertThat(lld.getRecursive(-1)).isNull();
    }
    ...
    public void removeFirst() {
        ...
        lld.addLast("2");
        lld.addLast("3");
        assertThat(lld.toList()).containsExactly("0","1","2","3").inOrder();
        lld.removeFirst();
    ...
    public void removeLast() {
        ...
        assertThat(lld.toList()).containsExactly("0","1","2","3").inOrder();
        lld.removeLast();
        assertThat(lld.toList()).containsExactly("0","1","2").inOrder();
        lld.removeLast();
        lld.removeLast();
